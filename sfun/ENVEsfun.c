 ...
 *
 *         void sfun_out(ShellAffine   u1[1], GroundContact y1[1], double        p9[1], double        p10[1]) 
 *
 *    Simulink version           : 10.4 (R2021b) 14-May-2021
 *    C source code generated on : 16-Oct-2022 15:00:46
 *
...
/**
     ...
     def.OutputFcnSpec = 'void sfun_out(ShellAffine   u1[1], GroundContact y1[1], double        p9[1], double        p10[1]) ';
     def.StartFcnSpec = 'void sfun_init(double p1[1], double p2[1], double p3[1], double p4[1], double p5[1], double p6[1], double p7[1], double p8[1]) ';
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "ShellAffine", &dataTypeIdReg);
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __ShellAffineId = ssGetDataTypeId(S, "ShellAffine");
        ...
        /* Get information for accessing ShellAffine.hub_affine */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __ShellAffineId, 0);
        ...
        {
            ShellAffine* __u1BUS = (ShellAffine*)calloc(sizeof(ShellAffine), ssGetInputPortWidth(S, 0));
            if (__u1BUS==NULL) {
...

        {
            ...
            sfun_init(p1, p2, p3, p4, p5, p6, p7, p8);
        }
    } /* if */
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        ShellAffine* __u1BUS = (ShellAffine*) ssGetPWorkValue(S, 1);
        ...
        /* Call the legacy code function */
        sfun_out(__u1BUS, __y1BUS, p9, p10);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'ShellAffine', specification */
    {
        uint32_T chk[] = {3138707206, 1065437616, 3207812620, 2509414126};
        int_T status;
        status = CheckDataTypeChecksum(S, "ShellAffine", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'ShellAffine'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'ShellAffine' definition has changed since the S-Function was generated");
        }
    }
}
