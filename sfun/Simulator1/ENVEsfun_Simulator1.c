/**
 * ENVEsfun_Simulator1.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void sfun_out(shellsRF      u1[1], groundContact y1[1], double        p9[1], double        p10[1]) 
 *
 *    Simulink version           : 10.4 (R2021b) 14-May-2021
 *    C source code generated on : 21-Jul-2022 17:50:37
 *
...
/**
     ...
     def.OutputFcnSpec = 'void sfun_out(shellsRF      u1[1], groundContact y1[1], double        p9[1], double        p10[1]) ';
...
#define S_FUNCTION_NAME  ENVEsfun_Simulator1
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        if (isSimulationTarget) {
            ...
            ssRegMdlInfo(S, "ENVEsfun_Simulator1_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "ENVEsfun_Simulator1_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Get information for accessing shellsRF.RFw */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __shellsRFId, 0);
        __dtBusInfo[9] = 16*__dtSizeInfo[1];
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        (void) memcpy(__u1BUS[0].RFw, u1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        ...
        (void) memcpy(y1 +  __dtBusInfo[6], &__y1BUS[0].in_mesh,  __dtBusInfo[7]);
    } /* if */
}
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {722475773, 3911408527, 2365026374, 2489752509};
        int_T status;
