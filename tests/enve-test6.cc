...
// TEST 6 - LOAD THE DATA FROM AN OBJ FILE.
...
main()
{
  ...
  try
  {
    ...
    // Create frame object
    affine pose;
    pose = translate(0.2, 0.0, 0.32) * angleaxis(yaw_angle, UNITZ_VEC3) * angleaxis(camber_angle, UNITX_VEC3) * angleaxis(pitch_angle, UNITY_VEC3);
