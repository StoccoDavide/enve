...
namespace acme
{
  ...
  static plane const & NAN_PLANE   = * new plane(NAN_POINT, NAN_VEC3); //!< Not-a-Number static const plane object
  static plane       & DUMMY_PLANE = * new plane(NAN_POINT, NAN_VEC3); //!< Dummy static non-const plane object
